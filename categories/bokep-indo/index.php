...
$api_url = "https://vidwish.com/api/vidwish.php?content=1&page={$page}&limit=12&order=latest";
...
<html lang="en">
  <head>
    ...
    <title>Bokep Indo Categories - <?= htmlspecialchars($config['site_title']) ?></title>
  ...
  <body class="dark-mode">
    ...
    <script>
      function addActiveClass() {
        const ActiveButton = document.getElementById('bokep-indo');
        if (ActiveButton) {
